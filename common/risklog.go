...
func init() {
	...
	DebugLogger1 = log.NewLogger("./logs/debug.log", zapcore.InfoLevel, 500, 30, 7, true, "riskclient").Sugar()
	ErrorLogger = log.NewLogger("./logs/error.log", zapcore.InfoLevel, 500, 30, 7, true, "riskclient").Sugar()
	WarnLogger = log.NewLogger("./logs/warn.log", zapcore.InfoLevel, 500, 30, 7, true, "riskclient").Sugar()
